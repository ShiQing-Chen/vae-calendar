var calendar = (function () {
    ...
    var nStr4 = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];
    var nStr5 = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
    ...
    var calendar = {
         ...
         * 星期数字转英文速查表
         * @Array Of Property
         * @trans ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]
         * @return Cn string
         */
        nStr4: nStr4,
        /**
         * 月份转英文速查表
         * @Array Of Property
         * @trans ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]
         * @return Cn string
         */
        nStr5: nStr5,
        /**
